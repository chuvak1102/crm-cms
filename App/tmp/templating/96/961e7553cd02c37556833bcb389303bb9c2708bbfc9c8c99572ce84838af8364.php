...
/* gallery.twig */
class __TwigTemplate_418b85401a1f738b6f62d0a4877d5446553e7dbfeaefdf04e4e06fa8827da5dd extends Twig_Template
{
    private $source;
    ...
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("layout.twig", "gallery.twig", 1);
        $this->blocks = array(
    ...
    <div class=\"row\">
        ...
        <ul class=\"index-catalog product\">
            {% for i in products %}
                <li>
                    <span class=\"product\">
                        <a href=\"{{ path }}/katalog-tovarov/{{ i.alias }}\">
                            <div class=\"img\">
                                <img class=\"image\" src=\"/files/mini/{{ i.image }}\" alt=\"\">
                            </div>
                            <span class=\"name\">{{ i.name | raw }}</span>
...
{% endblock %}
", "gallery.twig", "/var/www/u0742521/data/www/eco/App/Site/View/gallery.twig");
    }
}

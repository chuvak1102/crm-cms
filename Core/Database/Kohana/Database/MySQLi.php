...
class MySQLi extends \Core\Database\Database {
	...
	public function connect()
	{
		...
		if (\Core\Database\Database\MySQLi::$_set_names === NULL)
		{
			// Determine if we can use mysqli_set_charset(), which is only
			// available on PHP 5.2.3+ when compiled against MySQL 5.0+
			\Core\Database\Database\MySQLi::$_set_names = ! function_exists('mysqli_set_charset');
		}
		...
		catch (Exception $e)
		{
			...
			throw new \Exception(':error', array(':error' => $e->getMessage()), $e->getCode());
		}
	...
	public function set_charset($charset)
	{
		...
		if (\Core\Database\Database\MySQLi::$_set_names === TRUE)
		{
		...
		if ($status === FALSE)
		{
			throw new \Exception(':error', array(':error' => $this->_connection->error), $this->_connection->errno);
		}
	}
	...
	public function query($type, $sql, $as_object = FALSE, array $params = NULL)
	{
		...
		if (($result = $this->_connection->query($sql)) === FALSE)
		{
			...
			throw new \Exception(':error [ :query ]', array(
		...
		if ($type === \Core\Database\Database::SELECT)
		{
			...
			return new \Core\Database\Database\MySQLi\Result($result, $sql, $as_object, $params);
		}

...
class Insert extends \Core\Database\Database\Query\Builder {
	 ...
	 * @return  $this
	 */
	public function select(\Core\Database\Database\Query $query)
	{
		if ($query->type() !== \Core\Database\Database::SELECT)
		{

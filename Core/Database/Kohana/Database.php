...
abstract class Database {
	...
	public static function instance($name = NULL, array $config = NULL)
	{
		...
		if ( ! isset(Database::$instances[$name]))
		{
			...
			$driver = \Core\Database\Database\MySQL::class;
	...
	public function quote($value)
	{
		...
		{
			if ($value instanceof \Core\Database\Database\Query)
			{
				// Create a sub-query
				return '('.$value->compile($this).')';
			}
			elseif ($value instanceof \Core\Database\Database\Expression)
			{
	...
	public function quote_column($column)
	{
		...
		if ($column instanceof \Core\Database\Database\Query)
		{
			// Create a sub-query
			$column = '('.$column->compile($this).')';
		}
		elseif ($column instanceof \Core\Database\Database\Expression)
		{
			// Compile the expression
			$column = $column->compile($this);
		}
	...
	public function quote_table($table)
	{
		...
		if ($table instanceof \Core\Database\Database\Query)
		{
			// Create a sub-query
			$table = '('.$table->compile($this).')';
		}
		elseif ($table instanceof \Core\Database\Database\Expression)
		{
			// Compile the expression
			$table = $table->compile($this);
		}

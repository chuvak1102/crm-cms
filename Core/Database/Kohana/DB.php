...
class DB {
	...
	{
		return new \Core\Database\Database\Query($type, $sql);
	}
	...
	{
		return new \Core\Database\Database\Query\Builder\Select(func_get_args());
	}
	...
	{
		return new \Core\Database\Database\Query\Builder\Select($columns);
	}
	...
	{
		return new \Core\Database\Database\Query\Builder\Insert($table, $columns);
	}
	 ...
	 *
	 * @param   string  $table  table to updat
	 */
	public static function update($table = NULL)
	{
		return new \Core\Database\Database\Query\Builder\Update($table);
	}
	...
	{
		return new \Core\Database\Database\Query\Builder\Delete($table);
	}
	...
	{
		return new \Core\Database\Database\Expression($string, $parameters);
	}
